...
export function _useInstanceMst$(initFn, initIDBListenersOnMstSn, { unique_index, do_not_persist = false, inspectable = false, mobxDevtoolsMst, getOpenReplayObject, }) {
